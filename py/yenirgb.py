...
for i in range(len(image_list)):
    for z in range(len(image_list[0])):
        ch1 = 0
        ch2 = 0
        ch3 = 0
        for y in range(len(image_list[0])):
            ch1 += image_list[i][z][y][0]
            ch1_ort = int(ch1/(75))
            
            ch2 += image_list[i][z][y][1]
            ch2_ort = int(ch2/(75))
            
            ch3 += image_list[i][z][y][2]
            ch3_ort = int(ch3/(75))
